...
API_KEY = "SlTrzsYL9Ll-BlUtD6L1zkgObEyykis5yU_JET3hQ9hK"
...
def predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/30246d1e-e48c-427c-90b8-a0eb0ad79a0c/predictions?version=2022-01-19', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
    # print(data)
